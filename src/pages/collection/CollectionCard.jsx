...
function CollectionCard({title, artist, trackImg, handleClick, index}){
    return(
        <div className="collection-container duration-1000 rounded-2xl h-[234px] w-full sm:w-[213px] text-white overflow-hidden flex items-end relative">
            ...
            <div className='flex w-full h-full px-5 py-6 items-end justify-between z-10 color-gradient'>
                ...
                <svg data-id={index} onClick={handleClick} width="40" height="40" className="play-icon h-10 w-10 lg:opacity-0 transition-all duration-700" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
