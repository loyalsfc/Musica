...
function CollectionCard({title, artist, trackImg}){
    return(
        <div className="collection-container duration-1000 rounded-2xl h-[234px] w-[213px] text-white overflow-hidden flex items-end relative">
            <img src={trackImg} className="h-[234px] w-[213px] absolute top-0 left-0 transition-transform" />
            <div className='flex w-full h-full px-5 py-6 items-end z-10 color-gradient'>
                <div className='w-3/4 '>
                    ...
                    <p className="likes text-[10px] mt-6">2.3m likes</p>
                </div>
